...
```{bash, eval = FALSE}
conda create -y --name anvio-7.1 python=3.7
```
...
```{bash, eval = FALSE}
anvi-display-pan -p "/analysis_Anvio7/Pangenomic_Results/Cpsd/PAN_Cpsd-PAN.db" -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"

anvi-display-pan -p "/analysis_Anvio7/Pangenomic_Results/Cpro/PAN_Cpro-PAN.db" -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"

anvi-display-pan -p "/analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cacc-PAN.db" -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"

anvi-display-pan -p "/analysis_Anvio7/Pangenomic_Results/Ctub/PAN_Ctub-PAN.db" -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"
```
...
```{bash, eval = FALSE}
anvi-summarize -p "/analysis_Anvio7/Pangenomic_Results/Cpsd/PAN_Cpsd-PAN.db" \
               -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
               -o "/analysis_Anvio7/Cps_PAN_SUMMARY" \
               -C CorevsAccessory
               
anvi-summarize -p "analysis_Anvio7/Pangenomic_Results/Cpro/PAN_Cpro-PAN.db" \
               -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
               -o "/analysis_Anvio7/Cpr_PAN_SUMMARY" \
               -C CorevsAccessory
               
anvi-summarize -p "/analysis_Anvio7/Pangenomic_Results/Ctub/PAN_Ctub-PAN.db" \
               -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
               -o "/analysis_Anvio7/Ctu_PAN_SUMMARY" \
               -C CorevsAccessory
               
anvi-summarize -p "/analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cacc-PAN.db" \
               -g "/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
               -o "/analysis_Anvio7/Cac_PAN_SUMMARY" \
               -C CorevsAccessory
```
...
```{bash, eval=FALSE}
anvi-show-collections-and-bins -p "/analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cpro-PAN.db" --debug 
```

Find GC Content for *C. propinquum*:

```{bash, eval=FALSE}
anvi-summarize -g /analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /analysis_Anvio7/Pangenomic_Results/Cpro/PAN_Cpro-PAN.db -C CorevsAccessory
```

Find GC Content for *C. pseudodiphtheriticum*:

```{bash, eval=FALSE}
anvi-summarize -g /analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /analysis_Anvio7/Pangenomic_Results/Cpse/PAN_Cpse-PAN.db -C CorevsAccessory
```

Find GC Content for *C. accolens*:

```{bash, eval=FALSE}
anvi-summarize -g /analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cacc-PAN.db -C CorevsAccessory
```

Find GC Content for *C. tuberculostearicum*:

```{bash, eval=FALSE}
anvi-summarize -g /analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /analysis_Anvio7/Pangenomic_Results/Ctub/PAN_Ctub-PAN.db -C CorevsAccessory
```

# KEGG Analysis Pipeline

We then used a workflow from anvi'o ([https://merenlab.org/tutorials/infant-gut/#chapter-v-metabolism-prediction)](https://merenlab.org/tutorials/infant-gut/#chapter-v-metabolism-prediction)) that allowed us to estimate the completeness of KEGG modules in each of the four Corynebacterium pangenomes and in the combined pangenome for the 104 strains.

First we made a text document that was a list of the genome files excluding C. macingleyi. This was used as input for the estimate metabolism step. It contains two columns, the first column, labeled "Name", is the name of the strain genome, the second column, labeled "Contigs_db_path", is the file name and location of the genome database file.
...
For this run, we follow the same protocol except we included 27 D. pigrum genomes and included them in the genome list.
...
cacc <- read_excel("Cacc_metabolism_modules.xlsx")
cpro <- read_excel("Cprop_metabolism_modules.xlsx")
cpsd <- read_excel("Cpsd_metabolism_modules.xlsx")
ctub <- read_excel("Ctub_metabolism_modules.xlsx")
dpig <- read_excel("Pigrum_metabolism_modules.xlsx")
