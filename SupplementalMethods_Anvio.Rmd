...
This notebook contains analyses using anvi'o version 7.1.2 [@Eren2021]. For more in-depth information about anvi'o go to their official online site here: <https://anvio.org/>
...
The option `--log-bitscores` records the bit scores values. They were saved to the main folder for the repo, so we move them to a new subfolder:
...
anvi-gen-genomes-storage -e "analysis_Anvio7/All_107_CorynesAnvio.txt" -o "analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" --gene-caller Prodigal
```
...
We had to make new anvi'o environment with python 3.7 since the step below would not work unless we did that. This could be related to the updates with anvio 7.1 
```{bash, eval = FALSE}
...
```{bash, eval = FALSE}
#conda activate anvio-7.1
anvi-pan-genome -g analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -G Cacc.txt -o analysis_Anvio7/Pangenomic_Results/Cacc -n PAN_Cacc --use-ncbi-blast --mcl-inflation 10  --num-threads 8

anvi-pan-genome -g analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -G Cpro.txt -o analysis_Anvio7/Pangenomic_Results/Cpro -n PAN_Cpro --use-ncbi-blast --mcl-inflation 10  --num-threads 8

anvi-pan-genome -g analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -G Ctub.txt -o analysis_Anvio7/Pangenomic_Results/Ctub -n PAN_Ctub --use-ncbi-blast --mcl-inflation 10  --num-threads 8 

anvi-pan-genome -g analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -G Cpsd.txt -o analysis_Anvio7/Pangenomic_Results/Cpsd -n PAN_Cpsd --use-ncbi-blast --mcl-inflation 10  --num-threads 8
```
...
anvi-display-pan -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cpsd/PAN_Cpsd-PAN.db" -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"

anvi-display-pan -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cpro/PAN_Cpro-PAN.db" -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"

anvi-display-pan -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cacc-PAN.db" -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"

anvi-display-pan -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Ctub/PAN_Ctub-PAN.db" -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db"
```
...
```{bash, eval = FALSE}
#conda activate anvio-7
anvi-summarize -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cpsd/PAN_Cpsd-PAN.db" \
               -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
               -o "/Users/klemonlab/Downloads/Cps_PAN_SUMMARY" \
               -C CorevsAccessory
               
anvi-summarize -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cpro/PAN_Cpro-PAN.db" \
               -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
               -o "/Users/klemonlab/Downloads/Cpr_PAN_SUMMARY" \
               -C CorevsAccessory
               
anvi-summarize -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Ctub/PAN_Ctub-PAN.db" \
               -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
               -o "/Users/klemonlab/Downloads/Ctu_PAN_SUMMARY" \
               -C CorevsAccessory
               
anvi-summarize -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cacc-PAN.db" \
               -g "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db" \
...
```{bash, eval=FALSE}
anvi-show-collections-and-bins -p "/Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cpro-PAN.db" --debug 
```
...
anvi-summarize -g /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cpro/PAN_Cpro-PAN.db -C CorevsAccessory
```
...
```{bash, eval=FALSE}
# conda activate Anvio
anvi-summarize -g /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cpse/PAN_Cpse-PAN.db -C CorevsAccessory
```
...
```{bash, eval=FALSE}
# conda activate Anvio
anvi-summarize -g /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Cacc/PAN_Cacc-PAN.db -C CorevsAccessory
```
...
```{bash, eval=FALSE}
# conda activate Anvio
anvi-summarize -g /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Coryne-GENOMES.db -p /Users/klemonlab/Documents/CorPGA_rerun_aqr/analysis_Anvio7/Pangenomic_Results/Ctub/PAN_Ctub-PAN.db -C CorevsAccessory
```

# anvi'o KEGG Analysis Pipeline

```{bash, eval = FALSE}
cd ./Documents/CorPGA_rerun_aqr/analysis_Anvio7 # go to anvi'o environment
conda activate anvio-7.1.2
...
combo <- rbind(cacc_filt, cpro_filt, cpsd_filt, ctub_filt, dpig_filt)
``
...
combo2 <- rbind(cpro_filt2, cpsd_filt2, cacc_filt2, ctub_filt2, dpig_filt2)
library("writexl")
