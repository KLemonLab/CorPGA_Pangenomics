...
anvi-estimate-metabolism -e All_104_CorynesAnvio.txt -O Coryne_No_Mac --matrix-format
...
anvi-estimate-metabolism -e All_104_CorynesAnvio.txt -O Coryne_No_Mac_metabolism --kegg-output-modes modules,kofam_hits
```
...
We took the text file outputs with metabolism_modules from the previous steps on individiual species runs, including one for d pigrum, and converted them into xlsx files before reading them into R.
