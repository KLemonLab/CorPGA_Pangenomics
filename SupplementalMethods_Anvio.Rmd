...
anvi-gen-genomes-storage -e "data/genome_lists/CorPGA_Anvio_GenomeList_v01c.txt" -o $path_i/CorPGA-All4CorCgl-GENOMES.db --gene-caller Prodigal
...
output_path <- "data/Anvio8/Metabolic_Analysis/GC_fastas"
file <- "GC_00000656.fasta"
dist=dist.alignment(read.alignment(file.path(output_path, file),"fasta"), matrix = "identity")
