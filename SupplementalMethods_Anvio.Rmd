...
```{r}
# Read modules data and select only the genomes for the four nasal Corynebacterium species and Dolosigranulum pigrum. Made appropriate labeling columns
Modules <- read_delim("data/Anvio8/Metabolic_Analysis/CorPGA_modules.txt", show_col_types = FALSE, col_types = cols(unique_enzymes_hit_counts = col_character(), gene_caller_ids_in_module = col_character())) %>% 
...
# Summary tally table of fully complete modules by species
