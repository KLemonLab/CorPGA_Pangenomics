...
The option `--log-bitscores` records the bit scores values. They were saved to the main folder for the repo, so we move them to a folder:
...
```{bash, eval = FALSE}
cd ./Documents/CorPGA_rerun_aqr/analysis_Anvio7_1 # go to anvi'o environment
conda activate anvio-7.1.2
