...
# Conservative Core and Phylogeny of 73 *Corynebacterium* Genomes

## Running BDBH, COGS, & OMCL with 73 *Corynebacterium* Genomes

71 *Corynebacterium* genomes clustered with BDBH, COGS, and OMCL:

```{bash, eval=FALSE}
cd get_homologues

# Cluster with BDBH
./get_homologues.pl -d "/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/gbk_reduced" -n 8 -t 71 -C 90

# cluster with COGS
./get_homologues.pl -d "/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/gbk" -n 8 -t 0 -C 90 -G

# cluster with OMCL
./get_homologues.pl -d "/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/gbk" -n 8 -t 0 -C 90 -M
```

## Creating a Conservative Core Venn Diagram of 73 *Corynebacterium* genomes

```{bash, eval=FALSE}
cd get_homologues

# Creates a conservative core with the output of faa files
./compare_clusters.pl -o "/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/intersection" \
                      -d "/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/3x_clusters/CcaspiumDSM44850_f0_73taxa_algBDBH_e0_C90_","/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/3x_clusters/CcaspiumDSM44850_f0_0taxa_algCOG_e0_C90_","/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/3x_clusters/CcaspiumDSM44850_f0_0taxa_algOMCL_e0_C90_" \
                      -t 73
...
```{bash, eval=FALSE}
# Create a new directory to hold the faa and fna files
cd "/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/intersection"
mkdir -p "analysis_GH/All_gbk_faa_fna" 
...
# Run iqtree2
bin/iqtree2 -p "/Users/klemonlab/Desktop/THT/THT_CorPGA/CorPGA_Coryne_genus_tree/intersection/faa_fna_only/get_phylomarkers_run_AIR1tDNA_k0.7_m0.7_Tmedium_29Aug23/codon_alignments" --prefix Coryne_genus_CorPGA -alrt 1000 -B 1000 -T 8
```
