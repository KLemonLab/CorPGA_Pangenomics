...
We will want to use the gbk or gbf (genebank) file for each *Corynebacterium* strain genome from the prokka output. We copied and isolated the gbk files in new folders.
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Cpr" -A -t 19 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Cpr" -A -t 0 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Cps" -A -t 43 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Cps" -A -t 0 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Ctu" -A -t 8 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Ctu" -A -t 0 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Cac" -A -t 34 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA_Anvio/108_gbf/Cac" -A -t 0 -M -n 8 -C 90 -a 'CDS'
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA/108_gbk/All_107_Coryne" -n 8 -t 0 -C 90 -G
```
...
```{bash, eval=FALSE}
cd get_homologues
./get_homologues.pl -d "/Users/klemonlab/Downloads/Prokka_out_107_CorPGA/108_gbk/All_107_Coryne" -n 8 -t 0 -C 90 -M
```
...
mv *.fasta /Users/klemonlab/Documents/IQ-TREE-2.1.3-MacOSX/CorPGA_107_codon_alignment_files
```
...
./get_homologues.pl -d "/Users/klemonlab/Desktop/THT_CorPGA/CorPGA_Cpr" -n 8 -t 0 -C 90 -G # Runs COGS
./get_homologues.pl -d "/Users/klemonlab/Desktop/THT_CorPGA/CorPGA_Cpr" -n 8 -t 0 -C 90 -M # Runs OMCL
```
...
./get_homologues.pl -d "/Users/klemonlab/Desktop/THT_CorPGA/CorPGA_Cps" -n 8 -t 0 -C 90 -G # Runs COGS
./get_homologues.pl -d "/Users/klemonlab/Desktop/THT_CorPGA/CorPGA_Cps" -n 8 -t 0 -C 90 -M # Runs OMCL
```
...
```{bash, eval=FALSE}
cd "/Users/klemonlab/Documents/IQ-TREE-2.1.3-MacOSX"
...
mv *.fasta "/Users/klemonlab/Documents/IQ-TREE-2.1.3-MacOSX/CorPGA_20_Cpr_outgroup"
```
...
mv *.fasta "/Users/klemonlab/Documents/IQ-TREE-2.1.3-MacOSX/CorPGA_44_Cps_outgroup"
```
...
mv *.fasta "/Users/klemonlab/Documents/IQ-TREE-2.1.3-MacOSX/CorPGA_9_Ctu_outgroup"
```
...
mv *.fasta "/Users/klemonlab/Documents/IQ-TREE-2.1.3-MacOSX/CorPGA_35_Cac_outgroup"
```
